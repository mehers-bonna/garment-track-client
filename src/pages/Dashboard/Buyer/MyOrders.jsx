            ...
            <div className="inline-block min-w-full shadow rounded-lg overflow-hidden">
              <table className="min-w-full leading-normal">
                <thead className="hidden md:table-header-group">
                  <tr>
                    <th className="px-3 md:px-5 py-3 bg-white border-b border-gray-200 text-gray-800 text-left text-xs md:text-sm uppercase font-semibold">
                      Order Id
                    </th>
                    <th className="px-3 md:px-5 py-3 bg-white border-b border-gray-200 text-gray-800 text-left text-xs md:text-sm uppercase font-semibold">
                      Product
                ...
                <tbody>
                  {orders.length === 0 ? (
                    <tr>
                      ...
                      >
                        <p className="text-lg md:text-xl font-medium text-gray-500 py-10">
